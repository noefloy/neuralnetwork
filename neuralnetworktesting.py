...
"""
THIS IS ALL FOR TESTING. REPEAT, THIS IS ALL FOR TESTING.
"""
...
"""
    ...
    def backprop(self, activation, y):
        ...
        # going back through layers of neurons
    ...
    def update(self, minibatch, lrate):
        ...
        self.weights = [w-(lrate/len(minibatch))*nw
                        for w, nw in zip(self.weights, deriv_w)]
        self.biases = [b-(lrate/len(minibatch))*nb
                       for b, nb in zip(self.biases, deriv_b)]
